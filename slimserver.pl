...
sub initOptions {
	...
	my $gotOptions = GetOptions(
		...
		'nosetup'       => \$nosetup,
		'noserver'      => \$noserver,
		'statistics!'   => \$ignored_option,
		'upnp!'         => sub {$noupnp = !$_[1]},
		'sb1slimp3sync!'=> \$ignored_option,
		'localplayers!' => \$ignored_option,
		'remoteservices!'=> \$ignored_option,
		'ip3kplayers!'  => \$ignored_option,
		'transcoding!'  => \$ignored_option,
		'web!'          => \$ignored_option,
		'failsafe'      => \$failsafe,
