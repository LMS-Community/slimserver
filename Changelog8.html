<h2><a name="v8.4.0" id="v8.4.0"></a>Version 8.4.0</h2>
<ul>
	<li><a href="#v8.3.1">Upstream fixes from Logitech Media Server 8.3.x</a></li>
	<br />
	...
	<ul>
		...
		<li><a href="https://github.com/Logitech/slimserver/pull/862">#862</a> - Make lyrics on Default skin songinfo page collapsible (thanks AF-1!)</li>
		<li><a href="https://github.com/Logitech/slimserver/pull/868">#868</a> - Populate the release year ('year') attribute for remote tracks in the player queue (thanks SamInPgh!)</li>
		<li><a href="https://github.com/Logitech/slimserver/pull/956">#956</a> - Add raw AAC (ADTS) file support (thanks philippe44!)</li>
		<li><a href="https://github.com/Logitech/slimserver/pull/964">#964</a> - Handle case where user moves/adds/removes tracks in a playlist while the next track is already fully streamed (thanks philippe44!)</li>
	...
	<li>Bug Fixes:</li>
	<ul>
		<li><a href="https://github.com/Logitech/slimserver/issues/212">#212</a> - Unicode sorting for Browse Music Folder broken (thanks kimmot!)</li>
		...
		<li><a href="https://github.com/Logitech/slimserver/issues/905">#905</a> - Browsing in to playlists is extremely slow.</li>
		<li><a href="https://github.com/Logitech/slimserver/issues/911">#911</a> - Don't shut down the server on "restartserver" when we actually can't restart it.</li>
		<li><a href="https://github.com/Logitech/slimserver/issues/939">#939</a> - Player can't be switched from MySqueezebox.com to LMS</li>
		<li><a href="https://github.com/Logitech/slimserver/issues/962">#962</a> - Fix album_contributor updates in New &amp; Changed scan (thanks darrell!)</li>
		...
		<li><a href="https://github.com/Logitech/slimserver/pull/969">#969</a> - Add utf-8 guess decoding on Ogg metadata - thanks philippe44!</li>
...
<ul>
	...
	<li>Platform Support:</li>
	<ul>
		<li><a href="https://github.com/Logitech/slimserver/issues/891">#891</a> - Add Perl 5.36 support for Linux aarch64, armv7.</li>
		<li></li>
	</ul>
	<br />
	...
	<li>Bug Fixes:</li>
	<ul>
		<li><a href="https://github.com/Logitech/slimserver/pull/874">#874</a> - Fix shuffling when starting off with an empty playlist (thanks robho!)</li>
		<li><a href="https://github.com/Logitech/slimserver/pull/918">#918</a> - Fix browsing down to album favorites etc.</li>
...
<ul>
	...
	<ul>
		...
		<li><a href="https://github.com/Logitech/slimserver/issues/826">#826</a> - Add Perl 5.36 support for Linux x86_64.</li>
	...
	<li>Bug Fixes:</li>
	<ul>
		<li><a href="https://github.com/Logitech/slimserver/pull/827">#827</a> - Fix installation of plugin updates - honour user's choice (thanks mw9!)</li>
		<li>Don't use our custom Perl build on macOS 10.x - these versions come with a still working Perl 5.18.</li>
		<li><a href="https://github.com/Logitech/slimserver/pull/834">#834</a> - Fix no-transcoding playback of m4a audio (thanks philippe44!)</li>
		<li><a href="https://github.com/Logitech/slimserver/pull/835">#835</a> - Improve Alarm reliability - prevent accidental/random alarm stops.</li>
		<li><a href="https://github.com/Logitech/slimserver/pull/843">#843</a> - HTTPSocks.pm - Binary OR used by mistake - Logical OR needed (thanks mw9!).</li>
		<li>Remove support for "deflate" encoding type in SimpleHTTP requests: it must have been broken for over a decade!</li>
		<li><a href="https://github.com/Logitech/slimserver/pull/852">#852</a> - No result return while using Chinese Keyword in Fulltext Search.</li>
		<li><a href="https://github.com/Logitech/slimserver/pull/857">#857</a> - Fix changing MySB credentials using the "setsncredentials" command.</li>
	</ul>
	<br />
</ul>
...
<ul>
	...
	<ul>
		...
		<li><a href="https://github.com/Logitech/slimserver/issues/817">#817</a> - Fix JavaScript integration in settings pages for Classic/Light (and thus Material) skins.</li>
	...
	<ul>
		...
		<li><a href="https://github.com/Logitech/slimserver/issues/715">#715</a> - Remove I18N::LangTags - it's outdated and has been part of core Perl since 5.12.</li>
		...
		<li><a href="https://github.com/Logitech/slimserver/issues/773">#773</a> - Update flac to 1.3.4 (macOS, Linux i386, x86_64, armhf, aarch64)</li>
		...
		<li><a href="https://github.com/Logitech/slimserver/issues/810">#810</a> - Remove the 'deprecate' pragma vom CGI::Util to improve compatibility with newer Perl versions.</li>
	</ul>
	<br />
	...
	<ul>
		...
		<li><a href="https://github.com/Logitech/slimserver/issues/406">#406</a> - Crossfading fails with very short tracks</li>
		<li><a href="https://github.com/Logitech/slimserver/issues/410">#410</a> - Rescan button for individual music folders does not work in Classic (and hence Material) skin.</li>
		<li><a href="https://github.com/Logitech/slimserver/issues/473">#473</a> - Broken playback functionality in Album/More</li>
		...
		<li><a href="https://github.com/Logitech/slimserver/issues/699">#699</a> - Improve resume behaviour (thanks philippe44, maniac103 &amp; mw9</li>
		...
		<li><a href="https://github.com/Logitech/slimserver/pull/746">#746</a> - Windows 11: PreventStandby doesn't prevent standby any more</li>
		...
		<li><a href="https://github.com/Logitech/slimserver/pull/754">#754</a> - improve reliability of "what's new" podcast search (thanks philippe44!)</li>
...
<ul>
	...
	<ul>
		...
		<li><a href="https://github.com/Logitech/slimserver/issues/760">#760</a> - Fix various XSS possibilities in settings pages etc.</li>
	</ul>
	<br />
</ul>
