			...
			if (result.playlist_tracks > 0) {
				...
				if (result.playlist_loop[0].id && (el = Ext.get('ctrlCurrentArt'))) {
					...
					if (result.playlist_loop[0].artwork_url) {
						coverart = '<a href="' + webroot + infoLink + '?player=' + player + '&amp;item=' + result.playlist_loop[0].id + '" target="browser"><img src="' + result.playlist_loop[0].artwork_url + '" height="96" width="96" /></a>';
