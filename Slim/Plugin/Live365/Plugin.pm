...
use Slim::Plugin::Live365::Settings;
use Slim::Plugin::Live365::Web;
...
sub setMode {
	...
	if (!defined $live365->{$client} ) {
		$live365->{$client} = Slim::Plugin::Live365::Live365API->new;
	}
...
# Add web pages and handlers.  See Slim::Plugin::Live365::Web for handlers.
sub webPages {
	my $class = shift;
	...
	Slim::Web::HTTP::addPageFunction("$urlBase/browse.html",  \&Slim::Plugin::Live365::Web::handleBrowse);
	Slim::Web::HTTP::addPageFunction("$urlBase/search.html",  \&Slim::Plugin::Live365::Web::handleSearch);
	Slim::Web::HTTP::addPageFunction("$urlBase/action.html",  \&Slim::Plugin::Live365::Web::handleAction);
	Slim::Web::HTTP::addPageFunction("$urlBase/index.html",    \&Slim::Plugin::Live365::Web::handleIndex);
	Slim::Web::HTTP::addPageFunction("$urlBase/loginout.html", \&Slim::Plugin::Live365::Web::handleLogin);
}
...
sub initPlugin {
	...
	Slim::Player::ProtocolHandlers->registerHandler("live365", "Slim::Plugin::Live365::ProtocolHandler");

	Slim::Plugin::Live365::Settings->new;
...
#		  C  Q  T  F
	Slim::Control::Request::addDispatch(['live365', 'genres', '_index', '_quantity'],  
		 [0, 1, 1, \&Slim::Plugin::Live365::Web::cli_genresQuery]);
	Slim::Control::Request::addDispatch(['live365', 'stations', '_index', '_quantity'],  
		 [0, 1, 1, \&Slim::Plugin::Live365::Web::cli_stationsQuery]);
	Slim::Control::Request::addDispatch(['live365', 'playlist', '_mode'],  
		 [1, 0, 1, \&Slim::Plugin::Live365::Web::cli_playlistCommand]);
