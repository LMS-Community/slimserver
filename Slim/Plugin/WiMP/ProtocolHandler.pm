...
# default buffer 3 seconds of 256k audio
sub bufferThreshold { 32 * ( $prefs->get('bufferSecs') || 3 ) }
...
sub _getTrack {
	...
	my ($trackId) = $params->{url} =~ m{wimp://(.+)\.m4a};
