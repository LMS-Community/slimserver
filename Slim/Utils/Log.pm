...
# Copyright 2001-2011 Dan Sully, Logitech.
...
Returns the location of the server's scanner log file.
...
Returns a list of the the locations of the server's log files.
...
Returns the logging mode of the server's scanner log file.
...
Returns the location of the server's performance monitor log file.
...
Returns the logging mode of the server's performance monitor log file.
...
sub writeConfig {
	...
	print $fh "# If you wish to modify, make a copy and call the server\n";
