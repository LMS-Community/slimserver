...
Returns the location of SqueezeCenter's scanner log file.
...
Returns the location of SqueezeCenter's performance monitor log file.
...
sub defaultConfigFile {
	...
	my $dir = $logDir || Slim::Utils::OSDetect::dirsFor('prefs');
...
sub writeConfig {
	...
	print $fh "# If you wish to modify, make a copy and call SqueezeCenter\n";
