...
$Id: HiRes.pm,v 1.1 2004/05/01 04:28:18 dean Exp $

$Log: HiRes.pm,v $
Revision 1.1  2004/05/01 04:28:18  dean
Restructuring the CPAN binary modules to switch based on perl version (major or minor) as well as architecture.

Revision 1.2  2003/08/23 19:32:54  sadams
we need to set the accept()ed socket non-blocking. I don't think the
listening socket matters.

This fixes the blocking problem on Linux. HAven't tested on Windows or OSX.
