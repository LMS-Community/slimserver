;# $Id: Storable.pm,v 1.2 2004/12/11 23:50:49 vidur Exp $
;#
...
;#
;# $Log: Storable.pm,v $
;# Revision 1.2  2004/12/11 23:50:49  vidur
;# Phase 1 of landing the SQL backend database. In this phase, a SQLite database is used to store the information previously stored in the infoCache. We create the notion of a DataStore and a specific implementation based on Class::DBI and DBD::SQLite. The bulk of the Info.pm query and storage API is reimplmented based on these APIs, though clients of Info.pm continue to use the same APIs. In the next phase, we'll move some clients over to using the DataStore API directly.
;#
;# Revision 1.1.2.1  2004/08/14 18:21:19  dean
;# Sqlite (and necessary dependencies) for DB support on OSX 10.1 & 10.2
;#
;# Revision 1.1  2004/05/01 04:28:28  dean
;# Restructuring the CPAN binary modules to switch based on perl version (major or minor) as well as architecture.
;#
;# Revision 1.1.1.1  2003/07/18 19:42:06  dean
;# Restructured from SF
;#
;# Revision 1.1  2002/02/12 01:51:54  blackketter
;# Added MacOS X/Darwin Storable module...
;#
