...
$Id: HiRes.pm,v 1.2 2004/05/04 19:47:03 dean Exp $

$Log: HiRes.pm,v $
Revision 1.2  2004/05/04 19:47:03  dean
Fixing Time::HiRes version numbers.

Revision 1.1  2004/05/01 04:28:30  dean
Restructuring the CPAN binary modules to switch based on perl version (major or minor) as well as architecture.

Revision 1.3  2003/08/19 23:38:20  dean
Couple of merges from the main tree.

Fix up reconnection.  Fixes memory loss on squeezebox.

Revision 1.2  2003/08/14 20:15:33  dean
Fix the path problems that sean was having getting Time::HiRes to load on
mac.

Might be broken under 5.8, but this will get him working.
